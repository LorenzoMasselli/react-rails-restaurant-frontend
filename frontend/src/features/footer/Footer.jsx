        ...
        <footer className="footer">
            <div>
                ...
                <div className="footer-icons">
                    ...
                    <Link to="/react-rails-restaurant-frontend/admin"><FontAwesomeIcon icon={faUser} style={{color: "#ffffff", marginLeft: '15px'}} /> <span style={{color:"white",}}>(Admin Login)</span></Link>
                </div>
            </div>
